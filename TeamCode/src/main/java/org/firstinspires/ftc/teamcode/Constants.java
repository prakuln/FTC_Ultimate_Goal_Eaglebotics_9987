...
public class Constants {
    ...
    public static final double targetShooterPower = 0.475;    //EDIT THIS TO CHANGE THE POWER OF THE SHOOTER
    public static final double targetShotPower = 0.42; //EDIT THIS TO CHANGE THE POWER OF THE SHOOTER FOR THE POWER SHOT
